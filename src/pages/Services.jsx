...
const carddata = [
  ...
  },
  {
    ...
    link: "",
    Description:
      "Create your own website with TechPark Spaces - no setup required",
  },
  {
    title: "Exercises",
    link: "",
  ...
  },
  {
    ...
    link: "",
    Description:
      "Create a free TechPark Account to Improve Your Learning Experience    ",
  },
  {
    title: "My Learning",
    link: "",
    Description:
      "Track your learning progress at TechPark and collect rewards    ",
  },
  {
    title: "Upgrade",
    link: "",
  ...
  },
  {
    ...
    link: "",
    Description:
      " Host your own website, and share it to the world with TechPark Spaces  ",
  },
  {
    title: "How To's",
    link: "",
  ...
  return (
    <>
      <div className="containers ">
        ...
        <p className="service-p mt-3">
          TechPark offers a wide range of services and products for beginners
            ...
            <div className="col-lg-3 col-md-6" key={index}>
              <div className="cards h-100">
                <div className="cardbodys mt-3">
                  ...
                  <p
                    className="card-texts text-secondary"
                    style={{ fontSize: "14x " }}
                  >
                    {card.Description}
                  </p>
