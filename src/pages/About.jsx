  ...
  return (
    <>
      <Stack gap={1}>
        ...
        <div className="p-2">
          <img
            src="https://community.nasscom.in/sites/default/files/media/images/Content%20Marketing.png"
            className="about-image"
            alt="about us"
          />
          <div className="message">
            <p>
              we are work with professionals as well as people who first come to
              approach
            </p>
            <h1 className="about-h1">IN OUR COURSE </h1>
            <h5 className="margin">
              recording video are also avalable to access at any time
            </h5>
            <ul>
        ...
        <div className="p-3">
          <h4>
            TechPark<span className="spann">@</span>
            <span className="span">outlook.com</span>
          </h4>
        </div>
      </Stack>
    </>
